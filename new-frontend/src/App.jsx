        ...
        <div className={`app-layout ${collapsed ? 'is-collapsed' : ''}`}>
          ...
          <aside className="sidebar">
            ...
            <div className="sidebar-footer">
              {/* ── the colour bar ──
                  The press mark at the edge of the sheet, and the control for
                  how colour arrives. It carries the ceremony too. Each well
                  still paints straight from its pigment token, so earning one
                  is a CSS change. See components/InkStrip.jsx. */}
              <InkStrip />
