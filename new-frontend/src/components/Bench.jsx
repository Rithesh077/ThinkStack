  ...
  return (
    <div>
      {/* The folio counts what this page is about: how many models are on the
          bench, how many of those are actually on disk, and the tier the
          machine was graded at. The tier used to be readable only by finding
