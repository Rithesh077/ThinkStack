...
Test code & 8\,375 lines, 46 modules, 1\,042 tests \\
Interface tests & 213 tests, including every screen mounted \\
...
Releases published & 12, most recently v2.1.15 \\
Platforms built and validated automatically & 3 \\
\bottomrule
\end{tabular}
\end{center}

Figures are counted on the working branch at 14 August and include the citation
...
\midrule
Linux & automatically validated, and the replaced interface, the paper editor and citations exercised by hand on physical hardware \\
Windows & automatically validated; confirmed working by a human tester before the interface was replaced, and not driven by a person since \\
macOS & automatically validated; exercised by a tester before the interface was replaced, and not driven by a person since. Unsigned applications are still obstructed on first launch \\
