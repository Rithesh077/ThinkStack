...
as regions, and links show the strongest relations. The two clusters are the
change-point detection and post-quantum cryptography literatures; the space
between them is where the gap finder looks. Search, gap finding and the
